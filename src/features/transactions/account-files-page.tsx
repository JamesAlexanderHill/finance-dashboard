...
export const accountFilesLoader = getData

export type AccountFilesPageData = Awaited<ReturnType<typeof getData>>
...
export function AccountFilesPage(props: AccountFilesPageData) {
  const { user, account, accountFiles } = props
