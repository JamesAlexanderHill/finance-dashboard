...
export const fileDetailLoader = getData

export type FileDetailPageData = Awaited<ReturnType<typeof getData>>
...
export function FileDetailPage(props: FileDetailPageData) {
  const { user, account, file, fileEvents } = props
  const { accountId, fileId } = useParams({ strict: false }) as { accountId: string; fileId: string }
