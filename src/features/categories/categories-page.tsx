...
export const categoriesLoader = () => getData()

export type CategoriesPageData = Awaited<ReturnType<typeof getData>>
...
export function CategoriesPage({ user, categories }: CategoriesPageData) {
            ...
            >
              ...
              {isEditing ? (
                <div className="flex items-center gap-1.5 flex-1 min-w-0">
                  ...
                  />
                  <button onClick={onConfirmRename} className="p-0.5 text-green-600 hover:text-green-700 dark:text-green-500">
                    <Check className="size-4" />
                  </button>
                  <button onClick={onCancelEdit} className="p-0.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <X className="size-4" />
                  </button>
                </div>
              ) : isConfirmDelete ? (
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <button onClick={onConfirmDelete} className="p-0.5 text-red-600 hover:text-red-700 dark:text-red-500">
                    <Check className="size-4" />
                  </button>
                  <button onClick={onCancelDelete} className="p-0.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <X className="size-4" />
                  </button>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onClick={() => onStartEdit(cat)} title="Rename" className="p-1 text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 rounded">
                      <Pencil className="size-3.5" />
                    </button>
                    <button onClick={() => onStartDelete(cat.id)} title="Delete" className="p-1 text-gray-400 hover:text-red-600 dark:hover:text-red-400 rounded">
                      <Trash2 className="size-3.5" />
                    </button>
                    <button onClick={() => onStartAdd(cat.id)} title="Add child category" className="p-1 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 rounded">
                      <Plus className="size-3.5" />
                    </button>
                  </div>
                </>
